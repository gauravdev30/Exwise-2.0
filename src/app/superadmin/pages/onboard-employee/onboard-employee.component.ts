...
export class OnboardEmployeeComponent implements OnInit {
  ...
  initializeStaticEmployees() {
    const staticEmployees = [
      { id: 1, name: 'Rajesh Kumar', company: 'Infosys', designation: 'Software Engineer', phone: '+91-9876543210', email: 'rajesh.kumar@infosys.com', city: 'Bengaluru' },
      { id: 2, name: 'Priya Sharma', company: 'TCS', designation: 'Analyst', phone: '+91-9876543211', email: 'priya.sharma@tcs.com', city: 'Mumbai' },
      { id: 3, name: 'Amit Singh', company: 'Wipro', designation: 'QA Engineer', phone: '+91-9876543212', email: 'amit.singh@wipro.com', city: 'Hyderabad' },
      { id: 4, name: 'Sneha Patel', company: 'Tech Mahindra', designation: 'Project Manager', phone: '+91-9876543213', email: 'sneha.patel@techm.com', city: 'Pune' },
      { id: 5, name: 'Vikram Roy', company: 'HCL Technologies', designation: 'DevOps Engineer', phone: '+91-9876543214', email: 'vikram.roy@hcl.com', city: 'Chennai' }
    ];
