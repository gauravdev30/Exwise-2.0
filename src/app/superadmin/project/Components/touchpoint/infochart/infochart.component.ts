...
public lineChartData: ChartConfiguration<'line'>['data'] = {
  ...
  datasets: [
    { data: [ 0, 59, 80, 81, 56, 55, 40, 86, 64, 72, 34, 55, 67, 56, 46, 59, 83, 54], label: 'EX Satisfaction Score' },
    { data: [ 0, 48, 40, 19, 46, 77, 90, 67, 84, 56, 73, 74, 62, 75, 83, 74, 72, 74], label: 'EX Fondations Reality' },
    { data: [ 0, 39, 60, 11, 96, 35, 60, 66, 94, 72, 44, 95, 55, 73, 26, 89, 45, 34], label: 'EX Fondations Quality' },
  ]
};
