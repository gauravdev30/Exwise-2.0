export const environment = {
  production: true,
  baseUrl: 'http://ec2-43-204-150-67.ap-south-1.compute.amazonaws.com:8080/exwise/api/',
  baseUrl2: 'http://ec2-43-204-150-67.ap-south-1.compute.amazonaws.com:8080/exwise/api/',
