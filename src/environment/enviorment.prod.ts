export const environment = {
    production: true,
    baseUrl:'http://ec2-13-233-173-37.ap-south-1.compute.amazonaws.com:8080/exwise/api/',
    baseUrl2:'http://ec2-13-233-173-37.ap-south-1.compute.amazonaws.com:8080/exwise/api/',
    //https://api.exwiseinsight.com/production_exwise/api/
