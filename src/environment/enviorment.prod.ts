export const environment = {
    production: true,
    baseUrl:'http://ec2-13-127-136-153.ap-south-1.compute.amazonaws.com:8080/test_exwise/api/',
    baseUrl2:'http://ec2-13-127-136-153.ap-south-1.compute.amazonaws.com:8080/test_exwise/api/',
